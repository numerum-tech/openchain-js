...
describe("TransactionBuilder", function () {
    ...
    it("addRecord", function () {
        ...
        assert.deepEqual(builder.records, [{
                "key": ByteBuffer.fromHex("ab"),
                "value": {
                    "data": ByteBuffer.fromHex("cd")
                },
                "version": ByteBuffer.fromHex("ef")
            },
            {
                "key": ByteBuffer.fromHex("12"),
                "value": null,
                "version": ByteBuffer.fromHex("34")
            }
        ]);
    });
    ...
    it("updateAccountRecord goto", function () {
        ...
        return builder.updateAccountRecord("/path/", "/asset/", Long.fromInt(50)).then(function () {
            // goto record
...
var ApiClientMock = function () {
    ...
    this.getDataRecord = function (path, recordName) {
        ...
        return q.resolve({
            data: result,
            key: key,
            version: ByteBuffer.fromHex("aaaa")
        });
    };
    ...
    this.getAccountRecord = function (path, asset) {
        ...
        return q.resolve({
            balance: result,
            key: key,
            version: ByteBuffer.fromHex("bbbb")
        });
    };
};
